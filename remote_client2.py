...
# "stretch" = fill entire viewer window, may distort
# "fit"    = keep aspect ratio, black bars possible
SCALE_MODE = "stretch"
            ...
            with mss.mss() as sct:
                ...
                while not stop_event.is_set():
                    try:
                        ...
                        buffer = io.BytesIO()
                        img_pil.save(buffer, format="JPEG", quality=QUALITY, optimize=False)
