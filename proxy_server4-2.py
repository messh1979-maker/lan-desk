...
# Allow bandwidth probe packets, high-quality frames (near-lossless JPEG
# at native resolution), and clipboard file-transfer chunks. Keep this
# comfortably above the client's MAX_PAYLOAD (6 MB).
